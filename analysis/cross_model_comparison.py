...
Loads real benchmark trajectories, computes per-model metrics, runs statistical
tests, and generates comparison tables.

Usage:
    python analysis/cross_model_comparison.py
    python analysis/cross_model_comparison.py --results-dir experiments/results/raw
"""
...
def main():
    ...
    parser.add_argument("--results-dir", default="experiments/results/raw",
                        help="Directory containing per-model trajectory JSONL files")
