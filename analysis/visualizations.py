...
def plot_failure_distribution(records: List[Dict], output_dir: str = "analysis/results/figures") -> None:
    ...
    ax.set_title("AFAD: Failure Category Distribution (n=450)", fontweight="bold")
...
def generate_all_plots(results_dir: str = "experiments/results/raw",
                       output_dir: str = "analysis/results/figures") -> None:
    """Generate all standard AFA plots from real benchmark trajectories."""
    if not HAS_PLOTTING:
