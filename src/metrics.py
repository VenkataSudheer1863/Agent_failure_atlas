...
if __name__ == "__main__":
    ...
    test_records = [
        {"outcome": "failure", "recovered": False, "severity_score": 4,
         "failure_label": "PLAN", "trajectory": [{"step": 1}, {"step": 2}], "model": "Qwen3-8B"},
        {"outcome": "failure", "recovered": True, "severity_score": 3,
         "failure_label": "REAS", "trajectory": [{"step": 1}], "model": "Qwen3-8B"},
        {"outcome": "success", "recovered": False, "severity_score": 1,
         "failure_label": "TOOL", "trajectory": [{"step": 1}, {"step": 2}, {"step": 3}], "model": "Llama-3.2"},
    ]
